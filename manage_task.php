...
<head>
  ...
  <title>Control Panel | Manage Task</title>
       ...
       $.ajax({
         ...
         success: function (html) { 
           if(html==1){
             ...
             showSuccessAlert("Selected Item Deleted Successfully", "Success", 'manage_task.php');
           }
           else if(html==0){
...
<script type="text/javascript">
 function Respond(Id) {
   // Use SweetAlert for confirmation instead of standard confirm
   Swal.fire({
     title: 'Set Task Inactive',
     text: "Are you sure you want to set this task as inactive?",
     icon: 'warning',
     showCancelButton: true,
     confirmButtonColor: '#3085d6',
     cancelButtonColor: '#d33',
     ...
     if (result.isConfirmed) {
       $.ajax({
         ...
         success: function (html) {
           ...
           showSuccessAlert("Task set to inactive successfully", "Success", 'manage_task.php');
           return false;
         },
         error: function (e) {
           showErrorAlert("An error occurred while processing your request");
...
<script type="text/javascript">
 function UnRespond(Id) {
   // Use SweetAlert for confirmation instead of standard confirm
   Swal.fire({
     title: 'Set Task Active',
     text: "Are you sure you want to set this task as active?",
     icon: 'question',
     showCancelButton: true,
     confirmButtonColor: '#3085d6',
     cancelButtonColor: '#d33',
     ...
     if (result.isConfirmed) {
       $.ajax({
         ...
         success: function (html) {
           // Use SweetAlert instead of redirect
           showSuccessAlert("Task set to active successfully", "Success", 'manage_task.php');
           return false;
         },
         error: function (e) {
           showErrorAlert("An error occurred while processing your request");
