...
$session_roles=isset($_SESSION['role_id']) ? $_SESSION['role_id'] : 0;
$urll =$actionurl ;
...
$chk= ($chkurls_result !== null) ? $chkurls_result['c_id'] : 0;
...
return ($page_result !== null) ? $page_result['subcategory'] : '';
}
function gameid($a)
{
$selectruser=mysqli_query($a,"select `gameid` from `tbl_gameid` order by id desc limit 1");
$userresult=mysqli_fetch_array($selectruser);
return ($userresult !== null) ? $userresult["gameid"] : 0;
}
...
function wallet($a,$field,$id)
{
	...
	return ($walletResult !== null) ? $walletResult["$field"] : 0;
}
...
return ($result !== null) ? $result["$column"] : 0;
...
// Helper function to debug database issues
function debug_query($con, $query) {
