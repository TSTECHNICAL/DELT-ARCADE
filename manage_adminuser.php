...
<head>
  ...
  <title>Control Panel | Manage Control PanelUser</title>
       ...
       $.ajax({
         ...
         success: function (html) { 
           if(html==1){
             ...
             showSuccessAlert("Selected Item Deleted Successfully", "Success", 'manage_adminuser.php');
           }
           else if(html==0){
     ...
     if (result.isConfirmed) {
       $.ajax({
         ...
         success: function (html) {
           ...
           showSuccessAlert("User set to inactive successfully", "Success", 'manage_adminuser.php');
           return false;
         },
         error: function (e) {
           showErrorAlert("An error occurred while processing your request");
...
<script type="text/javascript">
 function UnRespond(Id) {
   ...
   Swal.fire({
     ...
     text: "Are you sure you want to set this user as active?",
     icon: 'question',
     showCancelButton: true,
     confirmButtonColor: '#3085d6',
     cancelButtonColor: '#d33',
     ...
     if (result.isConfirmed) {
       $.ajax({
         ...
         success: function (html) {
           // Use SweetAlert instead of redirect
           showSuccessAlert("User set to active successfully", "Success", 'manage_adminuser.php');
           return false;
         },
         error: function (e) {
           showErrorAlert("An error occurred while processing your request");
