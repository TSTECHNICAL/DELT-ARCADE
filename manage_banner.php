...
<head>
  ...
  <title>Control Panel | Manage Banner</title>
       ...
       $.ajax({
         ...
         success: function (html) { 
           if(html==1){
             ...
             showSuccessAlert("Selected Item Deleted Successfully", "Success", window.location.href);
           }
           else if(html==0){
     ...
     if (result.isConfirmed) {
       $.ajax({
         ...
         success: function (html) {
           ...
           showSuccessAlert("Item unpublished successfully", "Success", window.location.href);
           return false;
         },
         error: function (e) {
           showErrorAlert("An error occurred while processing your request");
...
<script type="text/javascript">
 function UnRespond(Id) {
   ...
   Swal.fire({
     title: 'Are You Sure?',
     text: "You want to publish this item?",
     icon: 'question',
     showCancelButton: true,
     confirmButtonColor: '#3085d6',
     cancelButtonColor: '#d33',
     ...
     if (result.isConfirmed) {
       $.ajax({
         ...
         success: function (html) {
           // Use SweetAlert instead of redirect
           showSuccessAlert("Item published successfully", "Success", window.location.href);
           return false;
         },
         error: function (e) {
           showErrorAlert("An error occurred while processing your request");
